...
WAV2VEC_COL_PREFIX = "w2v"
WAV2VEC_CHUNK_SECONDS = 20
WAV2VEC_MODEL_ID = "facebook/wav2vec2-base"

TRANSCRIPT_FILE_TEMPLATE = "{sid}_Transcript.csv"

TRANSCRIPT_SPEAKER_COL = "speaker"
TRANSCRIPT_START_TIME_COL = "start_time"
TRANSCRIPT_END_TIME_COL = "end_time"
TRANSCRIPT_VALUE_COL = "value"

TRANSCRIPT_KEEP_COLS = [TRANSCRIPT_SPEAKER_COL, TRANSCRIPT_START_TIME_COL, TRANSCRIPT_END_TIME_COL, TRANSCRIPT_VALUE_COL]
